...
export default function TeacherAssignmentTab({ id, name, text, files, dueDate, submissions }) {
        ...
        <>
            <Card className={'mb-3 mt-3'}>
                ...
                <Card.Body className={`d-${display}`}>
                    ...
                    <Button className={'mt-3'} onClick={() => relativeNav(`/${id}`)}>View All Submissions</Button>
                </Card.Body>
            </Card>
        </>
    )
